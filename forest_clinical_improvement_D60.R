...
forest_Clinical_Improvement_D60=function(data,comp.num,sliderRob=0,sliderDose=0,high_RoB=FALSE,keep_only="All population",model="Random-effects",
                                         sub="Severity",den=input$denominator,hide_dose=FALSE,hide_severity=FALSE){
  ...
  data=data[,c("Trial_ID","ID_stats","name_study","First_author","Year","Study_design","Funding","Conflict_of_interest_category",
               ...
               "ROB_4_Clinical_improvement","ROB_5_Clinical_improvement_D60","ROB_6_Clinical_improvement_D60"
  ...
  if(sub=="Severity"){
    #codes for severity#
    sev=ifelse(pair_data_01_60$Research_question=="Mild",1,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Mild outpatients",1,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Mild/moderate",2,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Moderate",3,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Mild to severe",4,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Moderate/severe",5,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Mild to critical",6,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Moderate to severe",7,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Moderate to critical",8,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Severe",9,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Severe/critical",10,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Unclear severity",11,sev)
    sev=ifelse(pair_data_01_60$Research_question=="Critical",12,sev)
  }
  ...
  analysis_data_01_60=cbind.data.frame(Trial_ID=new_data_01_60$Trial_ID,First_author=new_data_01_60$First_author,
                                       ...
                                       B=as.character(new_data_01_60$ROB_2_Deviations_from_intervention),
  ...
  #analysis_data_01_07$N1=as.numeric(analysis_data_01_07$N1)
  #analysis_data_01_60$N1=as.numeric(levels(analysis_data_01_60$N1))[analysis_data_01_60$N1]
  #analysis_data_01_60$N2=as.numeric(levels(analysis_data_01_60$N2))[analysis_data_01_60$N2]
  #analysis_data_01_60$r1=as.numeric(levels(analysis_data_01_60$r1))[analysis_data_01_60$r1]
  #analysis_data_01_60$r2=as.numeric(levels(analysis_data_01_60$r2))[analysis_data_01_60$r2]
  
  #analysis_data_01_07$sev=as.numeric(analysis_data_01_07$sev)
  #analysis_data_01_60sev=as.numeric(levels(analysis_data_01_60$sev))[analysis_data_01_60$sev]
  
  #analysis_data_01_07$subgroup=as.numeric(analysis_data_01_07$subgroup)
  #analysis_data_01_60$subgroup=as.numeric(levels(analysis_data_01_60$subgroup))[analysis_data_01_60$subgroup]
  ...
  #analysis_data_01_07$comp=as.numeric(analysis_data_01_07$comp)
  #analysis_data_01_60$comp=as.numeric(levels(analysis_data_01_60$comp))[analysis_data_01_60$comp]
  ...
  if(keep_only=="Mild population"){
    data_sev<- analysis_data_01_60 %>%
      filter(analysis_data_01_60$sev==1)
  ...
  if(keep_only=="Mixed population"){
    ...
    data_sev<-analysis_data_01_60 %>%
      filter(analysis_data_01_60$sev %in% c(2:11))
  ...
  if(keep_only=="Critical population"){
    ...
    data_sev<-analysis_data_01_60 %>%
      filter(analysis_data_01_60$sev==12)
  ...
  comp.num=comp.num
  #file_name="comp.num_01_07_pharma_rct.jpeg"
  #file_name=paste(comp.num,"_01_60_pharma_rct.jpeg",sep="")
  #jpeg(file=file_name,width=2431,height=1346,res=200)
  #meta-analysis#
  #rm(result_01_07)
  #rm(result_01_07.3)
  
  #analysis_data_01_07=subset(analysis_data_01_07_all,comp==comp.num & !is.na(counts1) & !is.na(counts2))
  ...
  if(nrow(analysis_data_01_60)>0){
    ...
    ilab=cbind(F_U_days=as.character(analysis_data_01_60$F_U_days),Intervention1=as.character(analysis_data_01_60$Intervention1),
               ...
               counts1=analysis_data_01_60$counts1,counts2=analysis_data_01_60$counts2)
    ...
    result_01_60=rma(measure="RR",ai=analysis_data_01_60$r1,bi=analysis_data_01_60$f1,ci=analysis_data_01_60$r2,
                     ...
                     subset=(analysis_data_01_60$comp==comp.num),add=1/2, to="only0",drop00=FALSE)
    
    if(model=="Fixed-effects"){
      
      result_01_60=update(result_01_60,tau2=0)
    }
    ...
    if(sum(analysis_data_01_60$r1)>0 | sum(analysis_data_01_60$r2)>0){
      ...
      if(sum(analysis_data_01_60$f1)>0 | sum(analysis_data_01_60$f2)>0){
        weights_model=update(result_01_60,drop00=T)
      }
    ...
    if (result_01_60$k>1 & nrow(analysis_data_01_60_0)>0){
      ...
      if(model=="Fixed-effects"){
        result_01_60.0=update(result_01_60.0,tau2=0) 
      ...
      if(ks0>1){
        ...
        if(model=="Fixed-effects"){
          ...
          result_01_60.0eff=update(result_01_60.0eff,tau2=0)
        }
        
      }
      else if (ks0==1 & analysis_data_01_60_0$r1==0 & analysis_data_01_60_0$r2==0){
        result_01_60.0eff=result_01_60.0
        ks0=0
      }
      else if (ks0==1 & analysis_data_01_60_0$r1>0 | analysis_data_01_60_0$r2>0){
        result_01_60.0eff=result_01_60.0
    ...
    if (result_01_60$k>1 & nrow(analysis_data_01_60_1)>0){
      ...
      if(model=="Fixed-effects"){
        result_01_60.1=update(result_01_60.1,tau2=0)
      }
      ...
      if(model=="Fixed-effects"){
        result_01_60.1eff=update(result_01_60.1eff,tau2=0)
      }
    ...
    if (result_01_60$k>1 & nrow(analysis_data_01_60_2)>0){
      ...
      if(model=="Fixed-effects"){
        result_01_60.2=update(result_01_60.2,tau2=0)}
      ...
      if(model=="Fixed-effects"){
        ...
        result_01_60.2eff=update(result_01_60.2eff,tau2=0)
      }
    ...
    if(result_01_60$k>1){
      ...
      if(model=="Fixed-effects"){
        ...
        result_01_60.3=update(result_01_60.3,tau2=0)
      }
      
      
      k00=result_01_60.3$k}
    
    else if(result_01_60$k==1 & analysis_data_01_60$r1==0 & analysis_data_01_60$r2==0){
      result_01_60.3=rma(measure="RR",ai=analysis_data_01_60$r1,bi=analysis_data_01_60$f1,ci=analysis_data_01_60$r2,
                         di=analysis_data_01_60$f2,slab=paste(analysis_data_01_60$First_author,analysis_data_01_60$Year,sep=", "),
                         subset=(analysis_data_01_60$comp==comp.num),add=1/2, 
                         to="only0",drop00=FALSE)
    ...
    if(k00==0 & result_01_60$k==1){
      metafor::forest(result_01_60,atransf=exp,showweights=F, xlab="Risk Ratio",header=c("Study                                  Follow up                Intervention 1         Intervention 2       r1/N1      r2/N2                                                                      Risk of Bias
    ...
    if(k00!=0 | result_01_60$k!=1){
      metafor::forest(result_01_60,atransf=exp,showweights=F, xlab="Risk Ratio",header=c("Study                                  Follow up                Intervention 1         Intervention 2       r1/N1      r2/N2                                                                      Risk of Bias
                                                 days                                                                                                                                                                 A       B       C       D       E       Overall"),cex=0.73,mlab="",
                      col="white",border="white",xlim=c(-28,20),alim=c(floor(result_01_60$ci.lb)-2,ceiling(result_01_60$ci.ub))+1,steps=4,
    ...
    if(k00!=0 | result_01_60$k!=1){
      addpoly.rma(result_01_60.3,row=-1,mlab="",col="darkblue",border="darkblue",atransf=exp,cex=0.9)
    }
    if(k00==0 & result_01_60$k==1){
    ...
    if (result_01_60$k>1){
      ...
      if (ks0>0 & ks1>0 & ks2==0){
        if(sub=="Severity"){
          addpoly.rma(result_01_60.1eff,row=1,mlab="                    Mixed population",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.0eff,row=ks1+2,mlab="                    Mild population",col="blue",border="blue",atransf=exp,cex=0.9)
        }
        
        if(sub=="Conflicts of interest"){
          addpoly.rma(result_01_60.1eff,row=1,mlab="                    Studies with conflicts of interest",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.0eff,row=ks1+2,mlab="                    Studies without conflicts of interest",col="blue",border="blue",atransf=exp,cex=0.9)
        }
        
        if(sub=="Funding"){
          addpoly.rma(result_01_60.1eff,row=1,mlab="                    Studies with public/non profit funding",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.0eff,row=ks1+2,mlab="                    Studies with mixed/private funding",col="blue",border="blue",atransf=exp,cex=0.9)
        }
        
        if(sub=="Location"){
          addpoly.rma(result_01_60.1eff,row=1,mlab="                    National studies",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.0eff,row=ks1+2,mlab="                    Multinational studies",col="blue",border="blue",atransf=exp,cex=0.9)
        }
      ...
      if (ks0>0 & ks1==0 & ks2>0){
        if(sub=="Severity"){
          addpoly.rma(result_01_60.2eff,row=1,mlab="                    Critical population",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.0eff,row=ks2+2,mlab="                    Mild population",col="blue",border="blue",atransf=exp,cex=0.9)
        }
        
        if(sub=="Funding"){
          addpoly.rma(result_01_60.2eff,row=1,mlab="                    Studies without specific funding",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.0eff,row=ks2+2,mlab="                    Studies with mixed/private funding",col="blue",border="blue",atransf=exp,cex=0.9)
        }
      ...
      if (ks0==0 & ks1>0 & ks2>0){
        if(sub=="Severity"){
          addpoly.rma(result_01_60.2eff,row=1,mlab="                    Critical population",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.1eff,row=ks2+2,mlab="                    Mixed population",col="blue",border="blue",atransf=exp,cex=0.9)
        }
        
        if(sub=="Funding"){
          addpoly.rma(result_01_60.2eff,row=1,mlab="                    Studies without specific funding",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.1eff,row=ks2+2,mlab="                    Studies with public/non profit funding",col="blue",border="blue",atransf=exp,cex=0.9)
        }
      }
      if (ks0>0 & ks1>0 & ks2>0){
        if(sub=="Severity"){
          addpoly.rma(result_01_60.2eff,row=1,mlab="                    Critical population",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.1eff,row=ks2+2,mlab="                    Mixed population",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.0eff,row=ks2+4+ks1,mlab="                    Mild population",col="blue",border="blue",atransf=exp,cex=0.9)
        }
        
        if(sub=="Funding"){
          addpoly.rma(result_01_60.2eff,row=1,mlab="                    Studies without specific funding",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.1eff,row=ks2+2,mlab="                    Studies with public/non profit funding",col="blue",border="blue",atransf=exp,cex=0.9)
          addpoly.rma(result_01_60.0eff,row=ks2+4+ks1,mlab="                    Studies with mixed/private funding",col="blue",border="blue",atransf=exp,cex=0.9)
        }
      }        
    }
    ...
    text(-6,3.5+max(allrows),"Pharmacological treatments",
         ...
         cex=1,
         col = "darkblue")
    text(-7,3+max(allrows),"Clinical improvement D60 or above",
         pos=4,
         cex=1)
    
    #get rob data#
    rob_data_01_60=cbind(Trial_ID=data$Trial_ID,A=as.character(data$ROB_1_randomization),
                         B=ifelse(is.na(data$ROB2_clinic_imp_D60),as.character(data$ROB_2_Deviations_from_intervention),as.character(data$ROB2_clinic_imp_D60)),
                         C=as.character(data$ROB_3__Clinical_improvement_D60),D=as.character(data$ROB_4_Clinical_improvement),E=as.character(data$ROB_5_Clinical_improvement_D60),
                         Overall=as.character(data$ROB_6_Clinical_improvement_D60))
    rob_data_01_60=as.data.frame(rob_data_01_60)
    ncomp=length(analysis_data_01_60$Trial_ID)
    A=rep("NA",ncomp)
    B=rep("NA",ncomp)
    C=rep("NA",ncomp)
    D=rep("NA",ncomp)
    ...
    nst=length(rob_data_01_60$Trial_ID)
    for(i in 1:ncomp){
      for(j in 1:nst){
        if(rob_data_01_60$Trial_ID[j]==analysis_data_01_60$Trial_ID[i]){
          A[i]=as.character(rob_data_01_60$A[j])
          B[i]=as.character(rob_data_01_60$B[j])
          C[i]=as.character(rob_data_01_60$C[j])
          D[i]=as.character(rob_data_01_60$D[j])
          E[i]=as.character(rob_data_01_60$E[j])
          Overall[i]=as.character(rob_data_01_60$Overall[j])
        }   
      }
    }
    ...
    analysis_data_01_60$A=A
    analysis_data_01_60$B=B
    analysis_data_01_60$C=C
    analysis_data_01_60$D=D
    analysis_data_01_60$E=E
    analysis_data_01_60$Overall=Overall
    analysis_data_01_60$A[analysis_data_01_60$A=="High"]="red"
    analysis_data_01_60$A[analysis_data_01_60$A=="Low"]="chartreuse3"
    analysis_data_01_60$A[analysis_data_01_60$A=="Some concerns"]="gold"
    analysis_data_01_60$B[analysis_data_01_60$B=="High"]="red"
    analysis_data_01_60$B[analysis_data_01_60$B=="Low"]="chartreuse3"
    analysis_data_01_60$B[analysis_data_01_60$B=="Some concerns"]="gold"
    analysis_data_01_60$C[analysis_data_01_60$C=="High"]="red"
    analysis_data_01_60$C[analysis_data_01_60$C=="Low"]="chartreuse3"
    analysis_data_01_60$C[analysis_data_01_60$C=="Some concerns"]="gold"
    analysis_data_01_60$D[analysis_data_01_60$D=="High"]="red"
    analysis_data_01_60$D[analysis_data_01_60$D=="Low"]="chartreuse3"
    analysis_data_01_60$D[analysis_data_01_60$D=="Some concerns"]="gold"
    analysis_data_01_60$E[analysis_data_01_60$E=="High"]="red"
    analysis_data_01_60$E[analysis_data_01_60$E=="Low"]="chartreuse3"
    analysis_data_01_60$E[analysis_data_01_60$E=="Some concerns"]="gold"
    analysis_data_01_60$Overall[analysis_data_01_60$Overall=="High"]="red"
    analysis_data_01_60$Overall[analysis_data_01_60$Overall=="Low"]="chartreuse3"
    analysis_data_01_60$Overall[analysis_data_01_60$Overall=="Some concerns"]="gold"
    
    #analysis_rob_01_07=subset(analysis_data_01_07,comp==comp.num & !is.na(counts1) & !is.na(counts2))
    
    analysis_rob_01_60= analysis_data_01_60 %>%
      filter(analysis_data_01_60$comp==comp.num)
    
    analysis_rob_01_60=analysis_rob_01_60[complete.cases(analysis_rob_01_60$counts1), ]
    ...
    if ((ks0==0 & ks2==0) | (ks0==0 & ks1==0) | (ks1==0 & ks2==0)){
      for(i in 1:result_01_60$k){
        legend(x=3.2,y=0.41+i+sliderRob,legend=c("", "","","","",""),
               col=c(analysis_rob_01_60$A[i],analysis_rob_01_60$B[i],analysis_rob_01_60$C[i],analysis_rob_01_60$D[i],analysis_rob_01_60$E[i],analysis_rob_01_60$Overall[i]), 
               cex=0.75,inset=0.1,bg="white",
               box.lty=0,title = "",fill = c(analysis_rob_01_60$A[i],analysis_rob_01_60$B[i],analysis_rob_01_60$C[i],analysis_rob_01_60$D[i],analysis_rob_01_60$E[i],analysis_rob_01_60$Overall[i]),pt.cex = 5
               ,x.intersp=0.5,
               horiz = TRUE,
               border = c(analysis_rob_01_60$A[i],analysis_rob_01_60$B[i],analysis_rob_01_60$C[i],analysis_rob_01_60$D[i],analysis_rob_01_60$E[i],analysis_rob_01_60$Overall[i]),
    ...
    if(hide_dose=="FALSE"){
      if(comp.num==comp.num){
        if ((ks0==0 & ks2==0) | (ks0==0 & ks1==0) | (ks1==0 & ks2==0)){
          for(i in 1:result_01_60$k){
            text(-16.5, -0.3+i+sliderDose, pos=4, analysis_rob_01_60$dose[i],cex=0.7)
          }
        }
        if (ks0>0 & ks1>0 & ks2==0){
          for(i in 1:ks1){
            text(-16.5, -0.3+i+1+sliderDose, pos=4, analysis_rob_01_60$dose[i],cex=0.7)
          }
          for(i in (ks1+1):(ks0+ks1)){
            text(-16.5, -0.3+i+2+sliderDose, pos=4, analysis_rob_01_60$dose[i],cex=0.7)
          }
        }
        if (ks0>0 & ks1==0 & ks2>0){
          for(i in 1:ks2){
        ...
        if (ks0>0 & ks1>0 & ks2>0){
          ...
          for(i in (ks1+ks2+1):(ks1+ks2+ks0)){
            text(-16.5, -0.3+i+4+sliderDose, pos=4, analysis_rob_01_60$dose[i],cex=0.7)
          }
        }
      }
    
    
    count=sum(str_count(analysis_rob_01_60$dose, "\\*"),na.rm = TRUE)
    ...
    if ((ks0==0 & ks2==0) | (ks0==0 & ks1==0) | (ks1==0 & ks2==0)){
      for(i in 1:result_01_60$k){
        if(hide_severity=="FALSE"){
          text(-28, 0.5+i, pos=4, analysis_rob_01_60$severity[i])
        }
        if(analysis_rob_01_60$r1[i]==0 & analysis_rob_01_60$r2[i]==0){
    ...
    if (ks0>0 & ks1>0 & ks2==0){
      for(i in 1:ks1){
        if(hide_severity=="FALSE"){
          text(-28, 0.5+i+1, pos=4, analysis_rob_01_60$severity[i])
        }
        if(analysis_rob_01_60$r1[i]==0 & analysis_rob_01_60$r2[i]==0){
      ...
      for(i in (ks1+1):(ks0+ks1)){
        if(hide_severity=="FALSE"){
          text(-28, 0.5+i+2, pos=4, analysis_rob_01_60$severity[i])
        }
        if(analysis_rob_01_60$r1[i]==0 & analysis_rob_01_60$r2[i]==0){
    ...
    if (ks0>0 & ks1>0 & ks2>0){
      ...
      for(i in (ks1+ks2+1):(ks1+ks2+ks0)){
        if(hide_severity=="FALSE"){
          text(-28, 0.5+i+4, pos=4, analysis_rob_01_60$severity[i])
        }
        if(analysis_rob_01_60$r1[i]==0 & analysis_rob_01_60$r2[i]==0){
    ...
    legend("bottomright",legend=paste("Data source: the COVID-NMA initiative (https://covid-nma.com/)"),
     ...
     par(font=2)
     N1_total=sum(analysis_data_01_60$N1)
     N2_total=sum(analysis_data_01_60$N2)
     r1_total=sum(analysis_data_01_60$r1)
     r2_total=sum(analysis_data_01_60$r2)
  ...
  else if (nrow(analysis_data_01_60)==0){
