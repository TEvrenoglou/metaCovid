...
)
{
  ...
  # data=data %>%
  #   filter(data$comp_type=="vaccine vs vaccine")
  ...
  data$F_U_days=ifelse(is.na(data$Sytemic_AE_timepoint),data$F_U_months,as.numeric(data$Sytemic_AE_timepoint))
  ...
  data$n_Randomized=as.numeric(data$AE_systemic_d14_denominator)
  ...
  data$AE_syst_d14=data$AE_syst_d14
  ...
  pair_data_05_14=pairwise_old(studlab=Trial_ID,treat=Treat_Name,event=AE_syst_d14,n=n_Randomized,
...
analysis_data_05_14=cbind.data.frame(Trial_ID=new_data_05_14$Trial_ID,First_author=new_data_05_14$First_author,
                                     ...
                                     B=as.character(new_data_05_14$ROB2_AE_systemic),
                                     C=as.character(new_data_05_14$ROB_3_AE_systemic),
                                     D=as.character(new_data_05_14$ROB_4_AE_systemic),
                                     E=as.character(new_data_05_14$ROB_5_AE_systemic),
                                     Overall=as.character(new_data_05_14$ROB_6_AE_systemic),
...
par(font=1)
text(-2.5,3.5+max(rows),"Systemic reactogenicity events",
     pos=4,
     cex=1)
# 
