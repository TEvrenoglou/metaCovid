...
forest_Adverse_D14_D28=function(data,comp.num,sliderRob=0,sliderDose=0,high_RoB=FALSE,keep_only="All population",model="Random-effects",
  ...
  data=data[,c("Trial_ID","ID_stats","name_study","First_author","Year","Study_design","Funding","Conflict_of_interest_category",
               ...
               "ROB_4_Adverse_events","ROB_5_Adverse_events","ROB_6_Adverse_events"
 ...
 # data$Treat_Dose_desc[data$Treat_Dose_desc=="at prescribers' discretion "]="-"
  ...
  if(sub=="Severity"){
    #codes for severity#
    sev=ifelse(pair_data_07_14$Research_question=="Mild",1,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Mild outpatients",1,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Mild/moderate",2,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Moderate",3,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Mild to severe",4,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Moderate/severe",5,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Mild to critical",6,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Moderate to severe",7,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Moderate to critical",8,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Severe",9,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Severe/critical",10,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Unclear severity",11,sev)
    sev=ifelse(pair_data_07_14$Research_question=="Critical",12,sev)
  }
  ...
  analysis_data_07_14=cbind.data.frame(Trial_ID=new_data_07_14$Trial_ID,First_author=new_data_07_14$First_author,
                            ...
                            D=as.character(new_data_07_14$ROB_4_Adverse_events),
  ...
  #analysis_data_07_14$N1=as.numeric(levels(analysis_data_07_14$N1))[analysis_data_07_14$N1]
  #analysis_data_07_14$N2=as.numeric(levels(analysis_data_07_14$N2))[analysis_data_07_14$N2]
  #analysis_data_07_14$r1=as.numeric(levels(analysis_data_07_14$r1))[analysis_data_07_14$r1]
  #analysis_data_07_14$r2=as.numeric(levels(analysis_data_07_14$r2))[analysis_data_07_14$r2]
  
  #analysis_data_07_14$sev=as.numeric(levels(analysis_data_07_14$sev))[analysis_data_07_14$sev]
  #analysis_data_07_14$subgroup=as.numeric(levels(analysis_data_07_14$subgroup))[analysis_data_07_14$subgroup]
  ...
  #analysis_data_07_14$comp=as.numeric(levels(analysis_data_07_14$comp))[analysis_data_07_14$comp]
  ...
  if(keep_only=="Mild population"){
    data_sev<- analysis_data_07_14 %>%
      filter(analysis_data_07_14$sev==1)
  ...
  if(keep_only=="Mixed population"){
    ...
    data_sev<-analysis_data_07_14 %>%
      filter(analysis_data_07_14$sev %in% c(2:11))
  ...
  if(keep_only=="Critical population"){
    ...
    data_sev<-analysis_data_07_14 %>%
      filter(analysis_data_07_14$sev==12)
...
#  jpeg(file=file_name,width=2431,height=1346,res=200)
  ...
  ilab=cbind(F_U_days=as.character(analysis_data_07_14$F_U_days),Intervention1=as.character(analysis_data_07_14$Intervention1),
             ...
             counts1=analysis_data_07_14$counts1,counts2=analysis_data_07_14$counts2)
  ...
  result_07_14=rma(measure="RR",ai=analysis_data_07_14$r1,bi=analysis_data_07_14$f1,ci=analysis_data_07_14$r2,
                   ...
                   subset=(analysis_data_07_14$comp==comp.num),add=1/2, to="only0",drop00=FALSE)
  
  if(model=="Fixed-effects"){
    result_07_14=update(result_07_14,tau2=0)
  }
  ...
  if(sum(analysis_data_07_14$r1)>0 | sum(analysis_data_07_14$r2)>0){
    ...
    if(sum(analysis_data_07_14$f1)>0 | sum(analysis_data_07_14$f2)>0){
      weights_model=update(result_07_14,drop00=T)
    }
  ...
  result_07_141=metabin(event.e = analysis_data_07_14$r1,n.e = analysis_data_07_14$N1,event.c = analysis_data_07_14$r2,
                        n.c = analysis_data_07_14$N2,sm="RR",byvar = analysis_data_07_14$subgroup,allstudies = T)
  ...
  if (result_07_14$k>1 & nrow(analysis_data_07_14_0)>0){
    ...
    if(model=="Fixed-effects"){
      result_07_14.0=update(result_07_14.0,tau2=0)
    }
    ...
    if(ks0>=1 & sum(analysis_data_07_14_0$r1)>0 | sum(analysis_data_07_14_0$r2)>0){
      ...
      if(model=="Fixed-effects"){
        result_07_14.0eff=update(result_07_14.0eff,tau2=0)
  ...
  if (result_07_14$k>1 & nrow(analysis_data_07_14_1)>0){
    ...
    if(model=="Fixed-effects"){
      result_07_14.1=update(result_07_14.1,tau2=0)
    }
    ...
    if(ks1>=1 & sum(analysis_data_07_14_1$r1)>0 | sum(analysis_data_07_14_1$r2)>0){
      ...
      result_07_14.1eff=rma(measure="RR",ai=analysis_data_07_14_1$r1,bi=analysis_data_07_14_1$f1,ci=analysis_data_07_14_1$r2,
                            ...
                            to="only0",drop00=TRUE)
      if(model=="Fixed-effects"){
        result_07_14.1eff=update(result_07_14.1eff,tau2=0)
      }
  ...
  if (result_07_14$k>1 & nrow(analysis_data_07_14_2)>0){
    result_07_14.2=rma(measure="RR",ai=analysis_data_07_14_2$r1,bi=analysis_data_07_14_2$f1,ci=analysis_data_07_14_2$r2,
                       ...
                       to="only0",drop00=FALSE)
    if(model=="Fixed-effects"){
      result_07_14.2=update(result_07_14.2,tau2=0)
    }
    ...
    if(ks2>=1 & sum(analysis_data_07_14_2$r1)>0 | sum(analysis_data_07_14_2$r2)>0){
      result_07_14.2eff=rma(measure="RR",ai=analysis_data_07_14$r1,bi=analysis_data_07_14$f1,ci=analysis_data_07_14$r2,
                            ...
                            to="only0",drop00=TRUE)
      if(model=="Fixed-effects"){
        result_07_14.2eff=update(result_07_14.2eff,tau2=0)}
  ...
  if(sum(analysis_data_07_14$r1)>0 | sum(analysis_data_07_14$r2)>0){
    result_07_14.3=rma(measure="RR",ai=analysis_data_07_14$r1,bi=analysis_data_07_14$f1,ci=analysis_data_07_14$r2,
                       ...
                       to="only0",drop00=TRUE)
    if(model=="Fixed-effects"){
      result_07_14.3=update(result_07_14.3,tau2=0)
  ...
  if(k00==0 & result_07_14$k==1){
    metafor::forest(result_07_14,atransf=exp,showweights=F, xlab="Risk Ratio",header=c("Study                                  Study Duration         Intervention 1         Intervention 2      r1/N1     r2/N2                                                                      Risk of Bias
                                                 days                                                                                                                                                                 A       B       C       D       E       Overall"),cex=0.73,mlab="",
                    col="white",border="white",xlim=c(-28,20),alim=c(-0.5,0.5),steps=4,
                    ilab=ilab,ilab.xpos=c(-19.8,-15,-10.5,-7.2,-5.3,14.2),rows=allrows,ylim=c(-1.5,3+max(allrows)),refline=NA,annotate=FALSE)       
  }
  ...
  if(k00!=0 | result_07_14$k!=1){
    ...
    metafor::forest(result_07_14,atransf=exp,showweights=F, xlab="Risk Ratio",header=c("Study                                  Study Duration         Intervention 1         Intervention 2      r1/N1     r2/N2                                                                      Risk of Bias
                                                 days                                                                                                                                                                 A       B       C       D       E       Overall"),cex=0.73,mlab="",
                    col="white",border="white",xlim=c(-28,20),alim=c(floor(result_07_14$ci.lb)-2,ceiling(result_07_14$ci.ub))+1,steps=4,
                    ilab=ilab,ilab.xpos=c(-19.8,-15,-10.5,-7.5,-5.1,14.2),rows=allrows,ylim=c(-1.5,3+max(allrows)),refline=NA)  
  }
  ...
  if(k00!=0 | result_07_14$k!=1){
    if(sum(analysis_data_07_14$r1)>0 | sum(analysis_data_07_14$r2)>0){
    addpoly.rma(result_07_14.3,row=-1,mlab="",col="darkblue",border="darkblue",atransf=exp,cex=0.9)}
    
    if(sum(analysis_data_07_14$r1)==0 & sum(analysis_data_07_14$r2)==0){
      addpoly.rma(result_07_14.3,row=-1,mlab="",col="white",border="white",atransf=exp,cex=0.9)}
  ...
  if (result_07_14$k>1){
    if (ks0>0 & ks1>0 & ks2==0){
      ...
      if(sub=="Severity"){
      addpoly.rma(result_07_14.1eff,row=1,mlab="                    Mixed population",col="blue",border="blue",atransf=exp,cex=0.9)
      addpoly.rma(result_07_14.0eff,row=ks1+2,mlab="                    Mild population",col="blue",border="blue",atransf=exp,cex=0.9)
      }
      if(sub=="Conflicts of interest"){
        addpoly.rma(result_07_14.1eff,row=1,mlab="                    Studies with conflicts of interest",col="blue",border="blue",atransf=exp,cex=0.9)
        addpoly.rma(result_07_14.0eff,row=ks1+2,mlab="                    Studies without conflicts of interest",col="blue",border="blue",atransf=exp,cex=0.9)
      }
      
      if(sub=="Funding"){
        addpoly.rma(result_07_14.1eff,row=1,mlab="                    Studies with public/non profit funding",col="blue",border="blue",atransf=exp,cex=0.9)
        addpoly.rma(result_07_14.0eff,row=ks1+2,mlab="                    Studies with mixed/private funding",col="blue",border="blue",atransf=exp,cex=0.9)
      }
      if(sub=="Location"){
        addpoly.rma(result_07_14.1eff,row=1,mlab="                    National studies",col="blue",border="blue",atransf=exp,cex=0.9)
        addpoly.rma(result_07_14.0eff,row=ks1+2,mlab="                    Multinational studies",col="blue",border="blue",atransf=exp,cex=0.9)
      }
    }
    if (ks0>0 & ks1==0 & ks2>0){
      if(sub=="Severity"){
      addpoly.rma(result_07_14.2eff,row=1,mlab="                    Critical population",col="blue",border="blue",atransf=exp,cex=0.9)
      addpoly.rma(result_07_14.0eff,row=ks2+2,mlab="                    Mild population",col="blue",border="blue",atransf=exp,cex=0.9)
      }
      
      if(sub=="Funding"){
        addpoly.rma(result_07_14.2eff,row=1,mlab="                    Studies without specific funding",col="blue",border="blue",atransf=exp,cex=0.9)
        addpoly.rma(result_07_14.0eff,row=ks2+2,mlab="                    Studies with mixed/private funding",col="blue",border="blue",atransf=exp,cex=0.9)
    ...
    if (ks0==0 & ks1>0 & ks2>0){
      if(sub=="Severity"){
      addpoly.rma(result_07_14.2eff,row=1,mlab="                    Critical population",col="blue",border="blue",atransf=exp,cex=0.9)
      addpoly.rma(result_07_14.1eff,row=ks2+2,mlab="                    Mixed population",col="blue",border="blue",atransf=exp,cex=0.9)
      }
      
      if(sub=="Funding"){
        addpoly.rma(result_07_14.2eff,row=1,mlab="                    Studies without specific funding",col="blue",border="blue",atransf=exp,cex=0.9)
        addpoly.rma(result_07_14.1eff,row=ks2+2,mlab="                    Studies with public/non profit funding",col="blue",border="blue",atransf=exp,cex=0.9)
      }
    ...
    if (ks0>0 & ks1>0 & ks2>0){
      ...
      addpoly.rma(result_07_14.2eff,row=1,mlab="                    Critical population",col="blue",border="blue",atransf=exp,cex=0.9)
      addpoly.rma(result_07_14.1eff,row=ks2+2,mlab="                    Mixed population",col="blue",border="blue",atransf=exp,cex=0.9)
      addpoly.rma(result_07_14.0eff,row=ks2+4+ks1,mlab="                    Mild population",col="blue",border="blue",atransf=exp,cex=0.9)
      }
      
      if(sub=="Funding"){
        addpoly.rma(result_07_14.2eff,row=1,mlab="                    Studies without specific funding",col="blue",border="blue",atransf=exp,cex=0.9)
        addpoly.rma(result_07_14.1eff,row=ks2+2,mlab="                    Studies with public/non profit funding",col="blue",border="blue",atransf=exp,cex=0.9)
        addpoly.rma(result_07_14.0eff,row=ks2+4+ks1,mlab="                    Studies with mixed/private funding",col="blue",border="blue",atransf=exp,cex=0.9)
      }
  ...
  text(-6,3.5+max(allrows),"Pharmacological treatments",
       ...
       cex=1,
       col = "darkblue")
  text(-5,3+max(allrows),"Adverse events",
       pos=4,
       cex=1)
  
  #get rob data#
  rob_data_07_14=cbind(Trial_ID=data$Trial_ID,A=as.character(data$ROB_1_randomization),
                       B=ifelse(is.na(data$ROB2_AE),as.character(data$ROB_2_Deviations_from_intervention),as.character(data$ROB2_AE)),
                       C=as.character(data$ROB_3_Adverse_events),D=as.character(data$ROB_4_Adverse_events),E=as.character(data$ROB_5_Adverse_events),
                       Overall=as.character(data$ROB_6_Adverse_events))
  
  rob_data_07_14=as.data.frame(rob_data_07_14)
  ncomp=length(analysis_data_07_14$Trial_ID)
  A=rep("NA",ncomp)
  B=rep("NA",ncomp)
  C=rep("NA",ncomp)
  D=rep("NA",ncomp)
  ...
  nst=length(rob_data_07_14$Trial_ID)
  
  # analysis_data_07_14$Trial_ID=as.numeric(analysis_data_07_14$Trial_ID)
  # rob_data_07_14$Trial_ID=as.numeric(rob_data_07_14$Trial_ID)
  
  for(i in 1:ncomp){
    for(j in 1:nst){
      if(rob_data_07_14$Trial_ID[j]==analysis_data_07_14$Trial_ID[i]){
        A[i]=as.character(rob_data_07_14$A[j])
        B[i]=as.character(rob_data_07_14$B[j])
        C[i]=as.character(rob_data_07_14$C[j])
        D[i]=as.character(rob_data_07_14$D[j])
        E[i]=as.character(rob_data_07_14$E[j])
        Overall[i]=as.character(rob_data_07_14$Overall[j])
      }   
    }
  }
  A=trimws(A)
  ...
  analysis_data_07_14$A=A
  analysis_data_07_14$B=B
  analysis_data_07_14$C=C
  analysis_data_07_14$D=D
  analysis_data_07_14$E=E
  analysis_data_07_14$Overall=Overall
  analysis_data_07_14$A[analysis_data_07_14$A=="High"]="red"
  analysis_data_07_14$A[analysis_data_07_14$A=="Low"]="chartreuse3"
  analysis_data_07_14$A[analysis_data_07_14$A=="Some concerns"]="gold"
  analysis_data_07_14$B[analysis_data_07_14$B=="High"]="red"
  analysis_data_07_14$B[analysis_data_07_14$B=="Low"]="chartreuse3"
  analysis_data_07_14$B[analysis_data_07_14$B=="Some concerns"]="gold"
  analysis_data_07_14$C[analysis_data_07_14$C=="High"]="red"
  analysis_data_07_14$C[analysis_data_07_14$C=="Low"]="chartreuse3"
  analysis_data_07_14$C[analysis_data_07_14$C=="Some concerns"]="gold"
  analysis_data_07_14$D[analysis_data_07_14$D=="High"]="red"
  analysis_data_07_14$D[analysis_data_07_14$D=="Low"]="chartreuse3"
  analysis_data_07_14$D[analysis_data_07_14$D=="Some concerns"]="gold"
  analysis_data_07_14$E[analysis_data_07_14$E=="High"]="red"
  analysis_data_07_14$E[analysis_data_07_14$E=="Low"]="chartreuse3"
  analysis_data_07_14$E[analysis_data_07_14$E=="Some concerns"]="gold"
  analysis_data_07_14$Overall[analysis_data_07_14$Overall=="High"]="red"
  analysis_data_07_14$Overall[analysis_data_07_14$Overall=="Low"]="chartreuse3"
  analysis_data_07_14$Overall[analysis_data_07_14$Overall=="Some concerns"]="gold"
  
  #analysis_rob_07_14=subset(analysis_data_07_14,comp==comp.num & !is.na(counts1) & !is.na(counts2))
  
  analysis_rob_07_14= analysis_data_07_14 %>%
    filter(analysis_data_07_14$comp==comp.num)
  
  analysis_rob_07_14=analysis_rob_07_14[complete.cases(analysis_rob_07_14$counts1), ]
  ...
  if ((ks0==0 & ks2==0) | (ks0==0 & ks1==0) | (ks1==0 & ks2==0)){
    for(i in 1:result_07_14$k){
      legend(x=3.2,y=0.41+i+sliderRob,legend=c("", "","","","",""),
             col=c(analysis_rob_07_14$A[i],analysis_rob_07_14$B[i],analysis_rob_07_14$C[i],analysis_rob_07_14$D[i],analysis_rob_07_14$E[i],analysis_rob_07_14$Overall[i]), 
             cex=0.75,inset=0.1,bg="white",
             box.lty=0,title = "",fill = c(analysis_rob_07_14$A[i],analysis_rob_07_14$B[i],analysis_rob_07_14$C[i],analysis_rob_07_14$D[i],analysis_rob_07_14$E[i],analysis_rob_07_14$Overall[i]),pt.cex = 5
             ,x.intersp=0.5,
             horiz = TRUE,
             border = c(analysis_rob_07_14$A[i],analysis_rob_07_14$B[i],analysis_rob_07_14$C[i],analysis_rob_07_14$D[i],analysis_rob_07_14$E[i],analysis_rob_07_14$Overall[i]),
  ...
  if (ks0==0 & ks1>0 & ks2>0){
    for(i in 1:ks2){
      legend(x=3.2,y=0.55+i+1+sliderRob,legend=c("", "","","","",""),
             col=c(analysis_rob_07_14$A[i],analysis_rob_07_14$B[i],analysis_rob_07_14$C[i],analysis_rob_07_14$D[i],analysis_rob_07_14$E[i],analysis_rob_07_14$Overall[i]), 
             cex=0.75,inset=0.1,bg="white",
             box.lty=0,title = "",fill = c(analysis_rob_07_14$A[i],analysis_rob_07_14$B[i],analysis_rob_07_14$C[i],analysis_rob_07_14$D[i],analysis_rob_07_14$E[i],analysis_rob_07_14$Overall[i]),pt.cex = 5
             ,x.intersp=0.5,
    ...
    for(i in (ks2+1):(ks1+ks2)){
      legend(x=3.2,y=0.55+i+2+sliderRob,legend=c("", "","","","",""),
             col=c(analysis_rob_07_14$A[i],analysis_rob_07_14$B[i],analysis_rob_07_14$C[i],analysis_rob_07_14$D[i],analysis_rob_07_14$E[i],analysis_rob_07_14$Overall[i]), 
             cex=0.75,inset=0.1,bg="white",
             box.lty=0,title = "",fill = c(analysis_rob_07_14$A[i],analysis_rob_07_14$B[i],analysis_rob_07_14$C[i],analysis_rob_07_14$D[i],analysis_rob_07_14$E[i],analysis_rob_07_14$Overall[i]),pt.cex = 5
             ,x.intersp=0.5,
  ...
  if(comp.num==comp.num){
    if ((ks0==0 & ks2==0) | (ks0==0 & ks1==0) | (ks1==0 & ks2==0)){
      for(i in 1:result_07_14$k){
        text(-16.5, -0.3+i+sliderDose, pos=4, analysis_rob_07_14$dose[i],cex=0.7)
      }
    }
    if (ks0>0 & ks1>0 & ks2==0){
      for(i in 1:ks1){
        text(-16.5, -0.3+i+1+sliderDose, pos=4, analysis_rob_07_14$dose[i],cex=0.7)
      }
      for(i in (ks1+1):(ks0+ks1)){
        text(-16.5, -0.3+i+2+sliderDose, pos=4, analysis_rob_07_14$dose[i],cex=0.7)
      }
    }
    if (ks0>0 & ks1==0 & ks2>0){
      for(i in 1:ks2){
    ...
    if (ks0>0 & ks1>0 & ks2>0){
      ...
      for(i in (ks1+ks2+1):(ks1+ks2+ks0)){
        text(-16.5, -0.3+i+4+sliderDose, pos=4, analysis_rob_07_14$dose[i],cex=0.7)
      }
    }
  }
  
  
  count=sum(str_count(analysis_rob_07_14$dose, "\\*"),na.rm = TRUE)
  ...
  if ((ks0==0 & ks2==0) | (ks0==0 & ks1==0) | (ks1==0 & ks2==0)){
    for(i in 1:result_07_14$k){
      ...
      text(-28, 0.5+i, pos=4, analysis_rob_07_14$severity[i])
      }
      if(analysis_rob_07_14$r1[i]==0 & analysis_rob_07_14$r2[i]==0){
        legend(12.5, 0.2+i, "                                                  ", box.col = "white", bg = "white", adj = 0.5)
        legend(-3, 0.2+i, "                                        ", box.col = "white", bg = "white", adj = 0.5)
      }
    }
  }
  if (ks0>0 & ks1>0 & ks2==0){
    for(i in 1:ks1){
      if(hide_severity=="FALSE"){
      text(-28, 0.5+i+1, pos=4, analysis_rob_07_14$severity[i])
      }
      
      if(analysis_rob_07_14$r1[i]==0 & analysis_rob_07_14$r2[i]==0){
        if(comp.num!=3){
        legend(12.5, 0.2+i+1, "                                                  ", box.col = "white", bg = "white", adj = 0.5)
        legend(-3, 0.2+i+1,"                                        ", box.col = "white", bg = "white", adj = 0.5)
        }
        
        if(comp.num==3){
          legend(15.8, 0.2+i+1.25, "                                                    ", box.col = "white", bg = "white", adj = 0.5,cex=0.5)
          legend(-4, 0.2+i+1.3, "                                                                                         ", 
    ...
    for(i in (ks1+1):(ks0+ks1)){
      if(hide_severity=="FALSE"){
      text(-28, 0.5+i+2, pos=4, analysis_rob_07_14$severity[i])
      }
      if(analysis_rob_07_14$r1[i]==0 & analysis_rob_07_14$r2[i]==0){
        if(comp.num!=3){
        legend(12.5, 0.2+i+2, "                                                  ", box.col = "white", bg = "white", adj = 0.5)
        legend(-3, 0.2+i+2, "                                        ", box.col = "white", bg = "white", adj = 0.5)
        }
        
        if(comp.num==3){
          legend(15.6, 0.2+i+2.4, "                                                           ", box.col = "white", bg = "white", adj = 0.5,cex=0.68)
  ...
  if (ks0>0 & ks1>0 & ks2>0){
    ...
    for(i in (ks1+ks2+1):(ks1+ks2+ks0)){
      if(hide_severity=="FALSE"){
      text(-28, 0.5+i+4, pos=4, analysis_rob_07_14$severity[i])
      }
      if(analysis_rob_07_14$r1[i]==0 & analysis_rob_07_14$r2[i]==0){
        legend(12.5, 0.2+i+3, "                                                  ", box.col = "white", bg = "white", adj = 0.5)
        legend(-3, 0.2+i+3, "                                        ", box.col = "white", bg = "white", adj = 0.5)
      }
    }
  }
  ...
  legend("bottomright",legend=paste("Data source: the COVID-NMA initiative (https://covid-nma.com/)"),
     ...
     par(font=2)
     N1_total=sum(analysis_data_07_14$N1)
     N2_total=sum(analysis_data_07_14$N2)
     r1_total=sum(analysis_data_07_14$r1)
     r2_total=sum(analysis_data_07_14$r2)
  ...
  if(result_07_14$k>1){
    ...
    text(-28, 0.2, pos=4, cex=0.9, bquote(paste("Heterogeneity: Q = ",
                                                ...
                                                ", p = ", .(formatC(result_07_14$QEp, digits=2, format="f")), "; ", I^2, " = ",
                                                .(formatC(result_07_14$I2, digits=1, format="f")), "%; ",tau^2," = ",
                                                .(formatC(result_07_14$tau2, digits=2, format="f")), "; ", "Test for subgroup differences: Q = ",
  ...
  else if (nrow(analysis_data_07_14)==0){
